...
//import static com.example.sairam.boomerang.MainActivity.REQUEST_IMAGE_CAPTURE;
...
public class CameraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_snapImage = (Button) findViewById(R.id.button_snapImage);
        imageView_preview = (ImageView) findViewById(R.id.imageView_preview);

        button_snapImage.setOnClickListener(new View.OnClickListener() {
            @Override
